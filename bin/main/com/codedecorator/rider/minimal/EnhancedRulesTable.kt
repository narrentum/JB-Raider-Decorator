...
/**
 * Кастомный рендерер для отображения цветовых ячеек
 */
class EnhancedColorTableCellRenderer : TableCellRenderer 
{
 ...
 */
class HighlightFontStyleCellEditor : AbstractCellEditor(), TableCellEditor 
{
 ...
 */
class HighlightTextDecorationCellEditor : AbstractCellEditor(), TableCellEditor 
{
...
class EnhancedColorTableCellEditor : AbstractCellEditor(), TableCellEditor 
{
    private val colorPanel = ColorPanel()
 ...
 */
class CustomBooleanTableCellEditor : AbstractCellEditor(), TableCellEditor 
{ //// ---- 
...
class CustomBooleanTableCellRenderer : TableCellRenderer 
{
    private val checkBox = JBCheckBox()
 ...
 */
class EnhancedRulesJTable(tableModel: RulesTableModel) : JTable(tableModel) 
{
    ...
    private fun setupCustomRenderers() {
        ...
        val colorRenderer = EnhancedColorTableCellRenderer()
        val colorEditor = EnhancedColorTableCellEditor()
        ...
        columnModel.getColumn(8).cellEditor = HighlightFontStyleCellEditor()
        columnModel.getColumn(9).cellEditor = HighlightTextDecorationCellEditor()
        ...
        println("[EnhancedRulesJTable] Setup custom renderers and editors")
    }
            ...
            override fun mouseClicked(e: java.awt.event.MouseEvent) {
                ...
                if (row >= 0 && col >= 0) {
                    ...
                    if (e.clickCount == 1) {
                        ...
                        if (editor != null) {
                            val component = editor.getTableCellEditorComponent(this@EnhancedRulesJTable, getValueAt(row, col), true, row, col)
