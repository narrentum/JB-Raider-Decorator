...
// import com.intellij.openapi.ap    // Публичный метод для обновления подсветки во всех редакторах
...
// class DirectHighlighterComponent2(private val project: Project) : ProjectComponent {
...
//                 println("---------------------------")
//                 println("[DirectHighlighter] Editor created")
//                 highlightEditor(editor)
...
//             // Добавим тестирование на конкретных строках
//             val lines = text.split('\n')
//             lines.forEachIndexed { lineIndex, line ->
//                 if (line.contains("TODO") || line.contains("FIXME")) {
//                     println("[DirectHighlighter] Line $lineIndex: '$line'")
//                 }
//             }
...
//     private fun findMatchesWithExclusion(text: String, target: String, exclusion: String): List<TextRange> {
//         val allMatches = findAllMatches(text, target)
//         return filterMatchesWithExclusion(text, allMatches, exclusion)
//     }
