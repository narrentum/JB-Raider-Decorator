...
//     // Throttled highlighting - ограничиваем до 1 раза в N секунд на редактор
...
//             println("[DirectHighlighter] Throttle skip for editor ${editor.document.hashCode()}, ${remainingTime}ms remaining")
//         }
//     }

//     private val activeHighlighters = mutableMapOf<Editor, MutableList<RangeHighlighter>>()
//     private val lastHighlightTime = mutableMapOf<Editor, Long>()
// import com.intellij.openapi.editor.EditorFactory
// import com.intellij.openapi.editor.colors.TextAttributesKey
// import com.intellij.openapi.editor.event.DocumentEvent
// import com.intellij.openapi.editor.event.DocumentListener
...
// class DirectHighlighterComponent1(private val project: Project) : ProjectComponent {
...
//             lastHighlightTime.remove(editor)
//         }
//     }
